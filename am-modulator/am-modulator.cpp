...
struct timeval  tv;
		...
		amModulator::amModulator (QSettings	*modulatorSettings,
	                                  int		rate,
...
void	amModulator::showSpectrum	(void) {
	scope	-> showSpectrum (scopeAmplifier -> value ());
}

#include <QCloseEvent>
void amModulator::closeEvent (QCloseEvent *event) {
